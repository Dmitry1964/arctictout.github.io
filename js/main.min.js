...
/* harmony import */ var _modules_init_menu__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/init-menu */ "./js/modules/init-menu.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_init_menu__WEBPACK_IMPORTED_MODULE_2__["mobileMenuNoJs"])(); // Modules
  // ---------------------------------
  ...
  _modules_init_menu__WEBPACK_IMPORTED_MODULE_2__["pageHeader"].addEventListener('click', function (evt) {
    if (evt.target === _modules_init_menu__WEBPACK_IMPORTED_MODULE_2__["headerButton"]) {
      Object(_modules_init_menu__WEBPACK_IMPORTED_MODULE_2__["onHeaderButtonHendler"])();
    } else {
      Object(_modules_init_menu__WEBPACK_IMPORTED_MODULE_2__["onHeaderLinkHendler"])();
    }
  });
  _modules_init_menu__WEBPACK_IMPORTED_MODULE_2__["headerList"].addEventListener('click', function () {
    Object(_modules_init_menu__WEBPACK_IMPORTED_MODULE_2__["onHeaderLinkHendler"])();
  });
}); // ---------------------------------
...
/*!*********************************!*\
  !*** ./js/modules/init-menu.js ***!
  \*********************************/
/*! exports provided: headerButton, headerList, pageHeader, onHeaderButtonHendler, mobileMenuNoJs, onHeaderLinkHendler */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onHeaderButtonHendler", function() { return onHeaderButtonHendler; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "mobileMenuNoJs", function() { return mobileMenuNoJs; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onHeaderLinkHendler", function() { return onHeaderLinkHendler; });
var pageBody = document.querySelector('.wrapper');
var pageHeader = document.querySelector('.page-header');
var headerNavigation = document.querySelector('.page-header__navigation');
var headerLogo = headerNavigation.querySelector('.page-header__logo');
var headerButton = headerNavigation.querySelector('.page-header__button');
var headerList = headerNavigation.querySelector('.page-header__list');
var headerTitle = document.querySelector('.page-header__title');
var pageMain = document.querySelector('.page-main');

var onHeaderButtonHendler = function onHeaderButtonHendler() {
...
var mobileMenuNoJs = function mobileMenuNoJs() {
  headerNavigation.classList.remove('page-header__navigation--nojs'); // headerNavigation.classList.add('page-header__navigation--mobile');
...
var onHeaderLinkHendler = function onHeaderLinkHendler() {
